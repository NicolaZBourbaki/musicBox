<?php
include("includesArtist/includedFiles.php");
...
?>
	...
	<?php 
		...
		echo "<button class='followButton' onclick='deleteArtist($artistId)'>Редагувати сторінку</button>";
...
<div class="gridViewContainer">
	...
	foreach($albumIdArray as $albumId) {
			...
			echo "<div class='gridViewItem'>
				<span role='link' tabindex='0' onclick='openPage(\"albumArtist.php?id=" . $ThisAlbum->getId() . "\")'>
	...
	<img src="assets/images/icons/addWhite.png" class="addAlbumIcon" onclick="openPage('newAlbum.php?id=<?php echo $artistId; ?>')" alt="add">
