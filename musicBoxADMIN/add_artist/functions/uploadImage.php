...
if($id != ''){
  ...
  $imgext = strtolower(preg_replace("#.+\.([a-z]+)$#i", "$1", $_FILES['upload_image']['name']));
      ...
      //����� ��� ��������
  $uploaddir = './artworkArtist/';
  //���� ���

  $newfilename = $_POST["artistName"].'-'.$id.rand(1,1000).'.'.$imgext;
  //���� �� �����
  ...
  if (move_uploaded_file($_FILES['upload_image']['tmp_name'], $uploadfile))
  {
    ...
    $update = mysql_query("UPDATE artists SET artistPic = '$newfilename' WHERE id = '$id'", $link);   
    echo ("<script>alert('Артиста успішно додано !');</script>");
  }
  else
  {
   $error_img[] =  "������� �������� �����.";    
