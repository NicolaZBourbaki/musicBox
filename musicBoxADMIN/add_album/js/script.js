$(document).ready(function() {
    ...
    $('<div id="addimage'+count_input+'" class="addimage"><input type="hidden" name="MAX_FILE_SIZE" value="2000000"/><input type="file" name="galleryimg[]" class="upload_music"/><a class="delete-input" rel="'+count_input+'" >Видалити</a></div><br/>').fadeIn(300).appendTo('#objects');       
